...
;(function() {
    ...
    evolu.lang = {
        ...
        /**
         * Create/recreate Evolu language with _name_: create new
         ...
         *   })
         *
         * @param name {String} Evolu language name
         * @param initializer {Function} will be receive new language as first
         *                    argument. Just syntax sugar to create language.    
         * return {evolu.lang.Language} new Evolu language
         */
         ...
         *
         * @param name {String} Evolu language name. Search will be case
                       insensitive
         * return {evolu.lang.Language} Evolu language, with `name`
         */
        get: function(name) {
            var lower = name.toLowerCase()
         ...
         *
         * @param name {String} full version of Evolu Lang program with
         *                      prefixes
         * return {evolu.lang.Code} compiled program as object
         */
     ...
     *
     * @param name {String} new language name
     * @constructor
     */
    ...
    evolu.lang.Language.prototype = {
         ...
         * 
         * @param package {Function} function, that add some changes to language
         * @return {evolu.lang.Language} current language
         */
         ...
         * @param name {Object} new command properties
         * @return {evolu.lang.Language} current language
         */
         ...
         * specify specify command number.
         * 
         * @param name {String} new condition name
         * @param name {Object} new command (condition is a type of command)
         *             properties
         * @return {evolu.lang.Language} current language
         */
         ...
         * 
         * @param bytes {Array of Numbers} bytes (numbers between 0 and 255) of
         *              Evolu Lang program source
         * @return {evolu.lang.Code} compiled program
         */
     ...
     *
     * @param language {evolu.lang.Language} Evolu language object of this
     *                 program
     * @constructor
     */
    ...
    evolu.lang.Code.prototype = {
         ...
         * 
         * @return {evolu.lang.Rule} new rule
         */
        rule: function() {
         ...
         * 
         * @param event {String} event name
         * @param params {Array} arguments for event callbacks
         */
         ...
         * @param param {String} condition parameter (on program code)
         * @return {Array of evolu.lang.Rule} rules with this condition and
         *         parameter
         */
         ...
         * 
         * @return {String} program source code
         */
        toSource: function() {
    ...
    evolu.lang.Rule.prototype = {
         ...
         * 
         * @param {Number} optional completed conditions number (default is 1)
         * @return {Number} count of uncompleted conditions
         */
        on: function(count) {

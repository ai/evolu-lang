...
;(function() {
    ...
    evolu.Language = function(name) {
        this.name = name
        this._commands = [this._separator]
    }
    ...
    evolu.Code = function(language) {
        ...
        var commands = this.language._commands
        for (var i = 0; i < commands.length; i++)
            if (commands[i].install) commands[i].install.call(this)
    }
    evolu.Code.prototype = {
        ...
        /** Initialize program. Run all rules without conditions. */
        init: function() {

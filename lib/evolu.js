...
;(function() {
    ...
    evolu.Language.prototype = {
        ...
        /**
         * Command _line_ property. Return rule line with command and optional
         * _param_.
         * 
         *   var code = new evolu.Code(lang)
         *   code.rule([lang.commands.send_signal.line('signal')])
         */
        _line: function(param) {
            if (undefined == param) {
                return { command: this }
            } else {
                return { command: this, param: param }
            }
        },
    ...
    evolu.Code.prototype = {
        ...
        /**
         * Add new rule with list [command, param] in arguments.
         * 
         *   code.rule(lang.commands.if_variable_is_zero.line(0),
         *             lang.commands.send_signal.line('empty'))
         */
        rule: function() {
            ...
            for (var i = 0; i < lines.length; i++) {
                ...
                for (var j = 0; j < this.language._list.length; j++) {
                    if (this.language._list[j] == command) {
                        command = j
                        break
                    }
                }
                ...
                param = lines[i].param
                if (undefined != param) {
                    if (lines[i].command.params) {
                        var params = lines[i].command.params
         ...
         * 
         *   code.down('if_variable_is_zero', 'a')
         */
         ...
         * 
         *   code.up('if_receive_signal', 'get_result')
         *   code.run()
         *   code.down('if_receive_signal', 'get_result')
         */
        run: function() {
